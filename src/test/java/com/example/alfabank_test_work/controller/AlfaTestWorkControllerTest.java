...
public class AlfaTestWorkControllerTest {
    ...
    void getGifTest() throws Exception {
        ...
        На внешние сервисы написаны моки.
            ...
            Написанные моки:
        - мок, который везвращает json представление курса валюты RUB по отношению к USD за 2022-06-05.
        - мок, который везвращает json представление курса валюты RUB по отношению к USD за 2022-06-04.
        - мок, который везвращает json представление курса валюты RUB по отношению к USD за 2022-06-02.
        - мок, который везвращает json представление доступных валют за 2022-06-05.
        ...
        /*
        Следующий мок везвращает json представление курса валюты RUB по отношению к USD за 2022-06-05.
         */
        ...
        /*
        Следующий мок везвращает json представление курса валюты RUB по отношению к USD за 2022-06-04.

        Согласно логике слоя сервиса, в место переменной localDate в адрес этого мока будет приходить вчершняя дата.
        ...
        /*
        Следующий мок везвращает json представление доступных валют за 2022-06-05.
         */
        ...
        /*
        Следующий мок везвращает json представление курса валюты RUB по отношению к USD за 2022-06-02.
